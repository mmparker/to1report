...
# Print
if(nrow(qfts_discord) > 0) { dfprint(qfts_discord) } else {
  cat("All recorded QFT results appear to be correct.")
} 
...
# Print
if(nrow(tspots_discord) > 0) { dfprint(tspots_discord) } else {
  cat("All recorded TSPOT results appear to be correct.")
} 
```
