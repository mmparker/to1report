...
if(nrow(winprob) > 0) { dfprint(winprob) } else {
...
missingtest <- subset(arrange(testres, VisitDate),
...
if(nrow(ageprob) > 0) { dfprint(ageprob) } else {
...
if(nrow(htwts$missingdf) > 0) { dfprint(htwts$missingdf) } else {
